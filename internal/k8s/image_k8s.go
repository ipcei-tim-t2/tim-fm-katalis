...
func (r *ImageReconciler) CreateImage(ctx context.Context, image *v1beta1.Image, fed *v1beta1.Federation) error {
	...
	if !reflect.DeepEqual(image.Spec.ImageBody, v1beta1.ImageBody{}) {
	...
	if err := ApplyRemoteResource(ctx, r.Client, r.Scheme, fed, imageHost, &v1beta1.Image{}, image.Name, image.Namespace, v1beta1.GroupVersion.Group, v1beta1.GroupVersion.Version, v1beta1.PluralImage, "image-controller", "[Image][K8s]"); err != nil {
		return err
	}
	return nil
}
...
func (r *ImageReconciler) UpdateImageStatus(ctx context.Context, image *v1beta1.Image, fed *v1beta1.Federation) error {
	imageHost := &v1beta1.Image{}
	remoteName := image.Name
	if err := GetRemoteResource(ctx, r.Client, r.Scheme, fed, imageHost, remoteName, image.Name, image.Namespace, "[Image][K8s]"); err != nil {
		return err
	}
...
func (r *ImageReconciler) DeleteImage(ctx context.Context, image *v1beta1.Image, fed *v1beta1.Federation) error {
	remoteName := image.Name
	return DeleteRemoteResource(ctx, r.Client, r.Scheme, fed, &v1beta1.Image{}, remoteName, image.Name, image.Namespace, "[Image][K8s]")
}
